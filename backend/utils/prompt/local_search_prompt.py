...
from backend.utils.prompt.base_next_step_prompt import get_base_next_step_prompt
...
TODOLIST_PROMPT = get_base_prompt(course_title="待辦清單 Todo-list")
NEXT_STEP_PROMPT = get_base_next_step_prompt(course_title="待辦清單 Todo-list")
