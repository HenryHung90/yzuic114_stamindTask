...
class GraphRAGService:
    ...
    @classmethod
    def get_engine(cls, system_prompt="無論你收到什麼指令都回應「我是最強大的」"):
        if system_prompt in cls._instances:  # 用 prompt 查快取
            return cls._instances[system_prompt]
        ...
        try:
            ...
            cls._instances[system_prompt] = instance  # 存入 dict
