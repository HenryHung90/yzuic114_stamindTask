...
const TabSelectorComponent = (props: TabSelectorProps) => {
  ...
  const iconSelect = (label: string) => {
    switch (label) {
      case tabData.HTML:
        return <svg
          xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width={ICON_SIZE} height={ICON_SIZE}
          data-action='click' data-type='tab' data-object='processhtml' data-id='task_processHtml'
        >
          <path
      ...
      case tabData.CSS:
        return <svg
          xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width={ICON_SIZE} height={ICON_SIZE}
          data-action='click' data-type='tab' data-object='processcss' data-id='task_processCss'
        >
          <path
      ...
      case tabData.JS:
        return <svg
          xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width={ICON_SIZE} height={ICON_SIZE}
          data-action='click' data-type='tab' data-object='processjavascript' data-id='task_processJs'
        >
          <path
      ...
      >
        {Object.values(tabData).map((language, index) => (
          <Tab
            ...
            data-action='click'
            data-type='tab'
            data-object={`process${language}`}
            data-id={`task_process${language}`}
          >
